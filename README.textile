...
* <code>before_initialize</code> (<code>onBeforeInitialize</code>) - triggered right after creating the anythingSlider object. "Read note":"#note-before-init".
* <code>initialized</code> (<code>onInitialized</code>) - triggered after creating the anythingSlider object.
...
* slider.currentPage - Currently displayed page/slide number.
...
p(#note-on-before-init). Please note that at this point almost nothing has been set:
# The <code>anythingSlider</code> object has been attached to the <code>ul</code>
# The class <code>anythingBase</code> was added to the <code>ul</code>
# The <code>ul</code> was wrapped in two <code>div</code>s (<code>div.anythingSlider div.anythingWindow</code>)
...
Bind the <code>on*</code> function to the corresponding events instead of calling them after triggering the event.
