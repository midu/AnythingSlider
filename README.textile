...
* Added an "AnythingSlider FX demo page":demos.htm with examples, code, and multiple methods to achieve the same effects. Thanks to Paal Joachim for input on which demos were needed.
